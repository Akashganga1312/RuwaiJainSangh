<%@ Page Title="Main Menu Master" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="MainMenuMaster.aspx.cs" Inherits="JainSanghInformation.MainMenuMaster" %>
            ...
            <div class="card-body">
                <div class="col-md-8">
                    <div class="row" style="justify-content: space-between;">
                        <a href="CreateNewMainMenu.aspx" class="btn">Create New</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <script type="text/javascript">  
        function confirmDelete(rowIndex, autoId) {
            if (confirm("Are you sure you want to delete this record?")) {
                $.ajax({
                    type: "POST",
                    url: "MainMenuMaster.aspx/DeleteRecord", // Replace with the actual server page URL that handles the delete operation
